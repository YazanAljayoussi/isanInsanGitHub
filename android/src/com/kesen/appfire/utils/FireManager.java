...
public class FireManager {
    ...
    public static void isHasFireApp(final String phone, final IsHasAppListener listener) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                //user not exists
                if (dataSnapshot.getKey() == "uidByPhone"){
                    Log.e("Error","uidByPhone");
                }
                if (dataSnapshot.getValue() == null || dataSnapshot.getKey() == "uidByPhone") {
                    listener.onNotFound();
                } else {
                    ...
                    FireConstants.usersRef.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.getValue() != null) {
                                ...
                                Log.e("onFound",String.valueOf(count)+"  "+phone);
                                listener.onFound(user);
                                count+=1;
                            } else {
                                listener.onNotFound();
                                Log.e("onNotFound",String.valueOf(count)+"  "+phone);
                                count+=1;
                            }
                        }
    ...
    public static void setMessagesAsRead(Context context, String chatId) {
        ...
        for (final Message message : results) {
            ServiceHelper.startUpdateMessageStatRequest(context, message.getMessageId(), FireManager.getUid(), MessageStat.READ);
        }
    }
    ...
    public static void setTypingStat(String receiverUid, int stat, boolean isGroup) {
        if (isGroup) {
