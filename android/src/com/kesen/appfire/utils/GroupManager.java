...
public class GroupManager {
    ...
    public static void fetchAndCreateGroup(final Context context, final String groupId, final OnFetchGroupsComplete onComplete) {
        ...
        FireConstants.groupsRef.child(groupId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!users.hasChild(FireManager.getUid())) {
                    if (onComplete != null)
                ...
                for (DataSnapshot snapshot : users.getChildren()) {
                    ...
                    if (user != null) {
                        ...
                        if (finalI == users.getChildrenCount()) {
                            createAndSaveGroup(adminUids, groupId, userList, groupName, thumbImg, photo, createdBy, createdAtTimestamp, onlyAdminsCanPost, onComplete);
                        }
                    } else {
                        if (!uid.equals(FireManager.getUid())) {
                            ...
                            if (finalI == users.getChildrenCount()) {
                                createAndSaveGroup(adminUids, groupId, userList, groupName, thumbImg, photo, createdBy, createdAtTimestamp, onlyAdminsCanPost, null);
                            }
                        }
                    }
                }
    ...
    private static void createAndSaveGroup(final RealmList<String> adminUids
            ...
            , boolean onlyAdminsCanPost, final OnFetchGroupsComplete onComplete) {
        ...
        FireConstants.groupsByUser.child(FireManager.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    fetchAndCreateGroup(MyApp.context(), groupId, new OnFetchGroupsComplete() {
                        @Override
