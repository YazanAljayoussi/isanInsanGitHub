 ...
 *
 * Renderables can be rendered directly using a {@link com.badlogic.gdx.graphics.g3d.Shader} (in which case the {@link #shader} member is ignored). Though more
 * typically Renderables are rendered via a {@link com.badlogic.gdx.graphics.g3d.ModelBatch}, either directly, or by passing a {@link RenderableProvider} like
 * {@link com.badlogic.gdx.graphics.g3d.ModelInstance} to the RenderBatch.</p>
 *
 * A ModelInstance returns all Renderables via its {@link com.badlogic.gdx.graphics.g3d.ModelInstance#getRenderables(Array, Pool)} method. In which case the
 ...
 * {@link com.badlogic.gdx.graphics.g3d.ModelBatch#begin(com.badlogic.gdx.graphics.Camera)} and {@link com.badlogic.gdx.graphics.g3d.ModelBatch#end()}. Therefor Renderable instances cannot
 * be reused for multiple render calls.</p>
 *
 * When the {@link #shader} member of the Renderable is set, the {@link ShaderProvider} of the {@link com.badlogic.gdx.graphics.g3d.ModelBatch} may decide to
...
public class Renderable {
    ...
    /** The {@link com.badlogic.gdx.graphics.g3d.Shader} to be used to render this Renderable using a {@link ModelBatch}, may be null. It is not guaranteed that
     * the shader will be used, the used {@link ShaderProvider} is responsible for actually choosing the correct shader to use. **/
    public com.kesen.echo.Shader shader;
