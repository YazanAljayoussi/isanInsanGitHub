package com.kesen.appfire.model.constants;
...
public class DBConstants {
    ...
    public static String isMuted = "isMuted";
    ...
    public static String isGroupBool = "isGroupBool";
    public static final String GROUP_DOT_IS_ACTIVE = "group.isActive";


    public static final String JOB_ID = "jobId";
    public static final String ID = "id";
    public static String isVoiceMessage = "isVoiceMessage";
