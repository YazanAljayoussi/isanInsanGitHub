...
import com.kesen.appfire.utils.ProximitySensor;
...
public class AudioService extends Service implements AudioManager.OnAudioFocusChangeListener
    ...
    public void play(final String id, String url, final int pos, int progress, int initialSensorState) {
        ...
        if (isPlaying() && pos == oldPos) {
            ...
            int streamType = getStreamType(initialSensorState, isHeadsetOn() ? HeadsetState.PLUGGED_IN : HeadsetState.UNPLUGGED);
