...
import static com.kesen.appfire.utils.IntentUtils.EXTRA_CURRENT_ALBUM_POSITION;
import static com.kesen.appfire.utils.IntentUtils.EXTRA_CURRENT_MESSAGE_ID;
import static com.kesen.appfire.utils.IntentUtils.EXTRA_FIRST_VISIBLE_ITEM_POSITION;
import static com.kesen.appfire.utils.IntentUtils.EXTRA_LAST_VISIBLE_ITEM_POSITION;
import static com.kesen.appfire.utils.IntentUtils.EXTRA_STARTING_POSITION;
        ...
        if (requestCode == REQUEST_CODE_FORWARD && resultCode == RESULT_OK) {
            ...
            if (selectedList.size() == 1) {
                ...
                for (User user : selectedList) {
                    Message forwardedMessage = MessageCreator.createForwardedMessage(message, user, FireManager.getUid());
                    ServiceHelper.startNetworkRequest(this, forwardedMessage.getMessageId());
                }
