...
import static com.kesen.appfire.model.constants.MessageStat.SENT;
...
public class DownloadManager {
            ...
            public void onComplete(@NonNull Task<FileDownloadTask.TaskSnapshot> task) {
                ...
                if (task.isSuccessful() && message.completeAfterDownload()) {
                    ...
                    if (MessageType.isVideo(type)) {
                        ...
                        RealmHelper.getInstance().setVideoThumb(messageId, videoThumb);
                    }
    ...
    public static void sendMessage(final Message message, final OnComplete onComplete) {
        ...
        FireConstants.getMessageRef(message.isGroup(), message.getChatId()).updateChildren(childUpdates).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
